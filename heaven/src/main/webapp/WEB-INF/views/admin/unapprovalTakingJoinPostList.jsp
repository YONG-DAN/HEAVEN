   ...
   <div class="container my-5">
	...
	<div class="row">
		<div class="col-lg-3">
			<div class="list-group">
				...
				<a href="${pageContext.request.contextPath }/admin/readUnapprovalJoinPostList.do?nowPage=1" class="list-group-item">미처리 신청서</a>
				<a href="${pageContext.request.contextPath }/admin/readRefusalApprovalJoinPostList.do?nowPage=1" class="list-group-item active">거절처리 신청서</a>
			</div>
		</div>
		<!-- /.col-lg-3 -->

		<div class="col-lg-9 adminJoinList">
			<h4 class="mb-4">미승인 재능기부 신청서</h4>
			<table class="table table-hover myList">
				...
				<tbody>						
					...
					<tr>
						...
						<td><a href="#" class="btn btn-sub-2 ml-auto mr-1 " id="#" >승인하기</a><a href="#" class="btn btn-sub-2 ml-auto mr-1 " id="#" >거절하기</a></td>
					</tr>
					</c:forEach>	
				</tbody>
			</table>
	...
	<ul class="pagination justify-content-center">
		<c:if test="${pb.previousPageGroup}">
			<li class="page-item">
				<a class="page-link" href="${pageContext.request.contextPath}/admin/readUnapprovalJoinPostList.do?nowPage=${pb.startPageOfPageGroup-1}" aria-label="Previous">
		...
		<c:forEach var="i" begin="${pb.startPageOfPageGroup}" end="${pb.endPageOfPageGroup}">
			<c:choose>
				<c:when test="${pb.nowPage!=i}">
					<li class="page-item">
						<a class="page-link" href="${pageContext.request.contextPath}/admin/readUnapprovalJoinPostList.do?nowPage=${i}">${i}</a>
					</li>
				</c:when>
				<c:otherwise>
					<li class="page-item">
		...
		<c:if test="${pb.nextPageGroup}">
			<li class="page-item">
				<a class="page-link" href="${pageContext.request.contextPath}/admin/readUnapprovalJoinPostList.do?nowPage=${pb.endPageOfPageGroup+1}" aria-label="Next">
