	...
	<div class="row">
		<div class="col-lg-3">
			<div class="list-group">
				...
				<a href="${pageContext.request.contextPath }/admin/readApprovalJoinPostList.do?nowPage=1" class="list-group-item ">승인 신청서</a>
