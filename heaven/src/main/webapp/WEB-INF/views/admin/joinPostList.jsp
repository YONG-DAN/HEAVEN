	...
	<div class="row">
		<div class="col-lg-3">
			<div class="list-group">
				<a href="${pageContext.request.contextPath }/admin/readTotalJoinPostList.do?nowPage=1" class="list-group-item">전체 신청서</a>
			...
			<table class="table table-hover myList">
				...
				<tbody>						
					...
					<tr>
						...
						<td>${jpgvo.joinPostStatusVO.jpStuatusName}</td>
					</tr>
					</c:forEach>	
				</tbody>
			</table>
			...
			<table class="table table-hover myList">
				...
				<tbody>						
					...
					<tr>
						...
						<td>${jptvo.joinPostStatusVO.jpStuatusName}</td>
					</tr>
					</c:forEach>	
				</tbody>
			</table>
