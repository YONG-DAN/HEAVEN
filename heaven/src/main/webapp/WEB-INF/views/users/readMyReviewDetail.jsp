	...
	<div class="row">
		<div class="col-9 offset-lg-1">
			<div class="d-flex align-items-end">
				<a href="${pageContext.request.contextPath}/users/readMyReviewList.do?nowPage=1" class="btn btn-sub-2-gnt ml-auto mr-1 " id="#" >목록</a>
				<a href="${pageContext.request.contextPath }/users/updateMyReviewForm.do?rpNo=${reviewPostVO.rpNo}" class="btn btn-sub-3-gnt mr-1" id="#">수정</a>
