...
<%--   						<c:set var="list" value="${listVO.mtVO}"/>
				...
				<c:set var="pb" value="${listVO.pbt}"></c:set>
					<c:if test="${pb.previousPageGroup}">	
					<li class="page-item">
						<a class="page-link" href="${pageContext.request.contextPath}/users/readMyMileageTradeList.do?nowPage=${pb.startPageOfPageGroup-1}" aria-label="Previous">
					...
					<li class="page-item">
						<a class="page-link" href="${pageContext.request.contextPath}/users/readMyMileageTradeList.do?nowPage=${i}">${i}</a>
					</li>
					</c:when>
					<c:otherwise>
					...
					<li class="page-item">
						<a class="page-link" href="${pageContext.request.contextPath}/users/readMyMileageTradeList.do?nowPage=${pb.endPageOfPageGroup+1}" aria-label="Next">
