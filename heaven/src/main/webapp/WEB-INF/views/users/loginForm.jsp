		...
		<div class="col-md-4 offset-md-4">
			<div class="card card-block login-form pt-5 pb-5">
				...
				<div class="card-body text-center">
					<span class="small-txt desc-color mr-1">아직 계정이 없으신가요?</span><a class="small-txt point-txt-gnt" href="${pageContext.request.contextPath }/users/registerCategory.do">가입하기</a>
