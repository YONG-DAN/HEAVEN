...
$(document).ready(function(){
	...
	$("#submitBtn").click(function(){
		...
		else if($("#addVolume").val()<5000) {
			alert("충전할 금액은 5000원 이상이어야 합니다.")
			$("#addVolume").val("").focus()
			addvolumeResult="";
		...
		<div class="row">
			...
			<div class="col-lg-3">
				<div class="list-group">
					<a href="${pageContext.request.contextPath }/users/addMileageForm.do" class="list-group-item active">마일리지 충전</a>
					<a href="${pageContext.request.contextPath }/users/exchangeMileageForm.do" class="list-group-item">마일리지 환전</a>
					<a href="${pageContext.request.contextPath }/users/readMyMileageTradeList.do?nowPage=1" class="list-group-item">마일리지 내역</a>
				</div>
			</div>
			<!-- /.col-lg-3 -->
			...
			<div class="col-lg-9">
				...
				<div class="card card-block login-form p-5">
					...
					<div class="card-body">
						...
						<input type="hidden" name="mvo" value="${sessionScope.uvo}">
							<div class="form-group">
								보유 마일리지: ${sessionScope.uvo.mileage} P <br>
							...
							<br><br>
							<button type="submit" class="btn btn-point btn-block" id="submitBtn">충전</button>
						</form>
					</div>
				</div>
			</div>
